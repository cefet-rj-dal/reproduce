...
#
# SoftED Experiment Utilities
# ---------------------------
# Central helper functions for experiments:
# - Load event detections and ground-truth references from disk
# - Group events per dataset/variable/method (and per well for 3W)
# - Compute Hard, SoftED and NAB metrics with timing
# - Prepare summary tables and k-aggregations
# - Compute NAB window lengths per series/dataset
#
# Notes:
# - We keep original dataset folder/file names (e.g., "gabarito_" prefix and
#   dataset names like "Tipo1") to match the provided data layout.
# - Metric implementations are sourced locally from softed/softed_metrics.
#
source("../softed_metrics/softed_metrics.r")
source("../softed_metrics/hard_metrics.r")
source("../softed_metrics/nab_metrics.r")
