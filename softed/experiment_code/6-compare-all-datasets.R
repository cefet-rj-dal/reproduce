...
## ------------------------
## Builds cross-dataset comparisons and summary plots:
## - Assembles SoftED vs Hard and NAB vs Hard results for 3W, NAB, Yahoo, TMN
## - Computes percentages, top-k distributions, mean differences, and times
## - Produces figures for the paper/analysis
##
