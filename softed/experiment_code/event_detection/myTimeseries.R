##
## Time Series Utilities (Sliding Window, Scaling, Splits)
## -------------------------------------------------------
## Core utilities for creating sliding windows, splitting train/test,
## and normalizing/denormalizing series. Used in ML-based detectors.
##
