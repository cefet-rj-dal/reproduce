##
## Harbinger Helpers (Event Detection Wrappers)
## -------------------------------------------
## Collection of helper wrappers around event detection routines used
## by the experiments. Each `evtdet.*` function takes a time-series
## data.frame (first column is time) and returns a data.frame with
## columns `time`, `serie`, and `type` describing detected events.
##
