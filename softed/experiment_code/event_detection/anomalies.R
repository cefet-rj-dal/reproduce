##
## Anomaly Utilities (Boxplot/KMeans/DBSCAN/ML)
## --------------------------------------------
## Helper functions to flag anomalies on sliding windows or raw vectors.
## Used by example detection scripts to produce event indices.
##
