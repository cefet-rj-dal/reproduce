...
## -------------------------------------
## Computes and stores metric evaluations for all datasets (3W, NAB, TMN, Yahoo):
## - Loads shared utilities and pre-loaded event/reference data
## - Runs Hard, SoftED (k-grid), and NAB scoring helpers
## - Saves RDS files with per-dataset aggregated results
##
