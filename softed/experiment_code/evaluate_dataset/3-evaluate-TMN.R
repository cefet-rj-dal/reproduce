##
## 3 - Evaluate TMN Dataset
## ------------------------
## Steps:
## - Optionally source Harbinger (if used in upstream data generation)
## - Load event detections and shared experiment utilities
## - Compute Hard, SoftED (k in {6,12,15,24} and 15..60), and NAB metrics
## - Generate comparison tables and plots (SoftED vs Hard, NAB vs Hard)
## - Compute NAB window lengths for reference analysis
##
