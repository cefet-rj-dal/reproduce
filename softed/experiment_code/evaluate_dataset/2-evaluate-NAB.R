##
## 2 - Evaluate NAB Dataset
## ------------------------
## Steps:
## - Load shared experiment utilities
## - Load event detections and references (timestamps in POSIXct)
## - Compute Hard, SoftED (k in 15..60), and NAB metrics
