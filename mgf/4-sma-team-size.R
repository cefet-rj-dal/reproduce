###############################################################################
# MGF Experiment 4 — Small Course Team Size Sweep
#
# Purpose
#   Compare different numbers of groups (team sizes) under fixed vertex/edge
#   settings; plot betweenness/closeness results across growth steps.
#
# Requirements
