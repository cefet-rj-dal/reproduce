...
source('/home/lucas/3w_experiments/reduced_combinations.R')
...
data_path <- '//home/lucas/ijcnn2025/3w/data/'
...
df <- as.data.frame(data_3w_tp3_real_sample_exp$`WELL-00001_20170320120025`)
...
# plot(x=df[,'batch_index'], y=df[ ,features[6]])
