...
source('/home/lucas/3w_experiments/best_combinations.R')
...
df <- as.data.frame(oil_3w_Type_2$Type_2$`WELL-00003_20141122214325`)

# read_parquet('/home/lucas/datasets/timeseries/3w/4/WELL-00002_20131104004101.parquet')
