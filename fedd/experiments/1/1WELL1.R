...
library(dalevents)
library(caret)
# Optional: source local helper with combinations if available under `core/`
# source('core/reduced_combinations.R')
...
df <- as.data.frame(oil_3w_Type_1$Type_1$`WELL-00001_20140124213136`)
