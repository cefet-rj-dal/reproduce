...
# R bridge for Amazon Chronos zero-shot predictions
# - Uses reticulate to call the Python implementation in ts_chronos.py
# - Exposes a daltoolbox-compatible regressor interface (fit/predict)
