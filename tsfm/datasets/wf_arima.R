## 4-modeling (ARIMA) — workflow
# Purpose: iterate datasets and series, run ARIMA baseline with a fixed test size.
# Dependencies: expects helper functions from wf_experiment.R (sourced below).
