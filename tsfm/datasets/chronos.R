## 4-modeling (Chronos, train/test split) — workflow
# Purpose: run Chronos using explicit train/test split CSVs per dataset.
# Dependencies: expects helper functions from wf_experiment.R and Chronos R bridge.
