##
## 4 - Currencies: Multi-Scale Event Detection
## -------------------------------------------
## Purpose:
## - Load currency rates (vs BRL) from the consolidated Excel dataset
## - Run multi-scale event detection per currency against EPU-based labels
