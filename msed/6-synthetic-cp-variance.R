##
## 6 - Synthetic Change-Point (Variance): Multi-Scale Event Detection
## ------------------------------------------------------------------
## Purpose:
## - Load synthetic variance-change series and reference labels
## - Evaluate MSED for change-point variance events at different soft windows
##
