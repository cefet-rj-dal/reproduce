##
## CEEMD decomposition + energy-ratio based component grouping
## -----------------------------------------------------------
## Splits a series into components (ve, sst, stf, oat, lt) using CEEMD and
## the Moghtaderi energy-ratio approach; returns components and aligned time.
require(lubridate)
library(hht)
