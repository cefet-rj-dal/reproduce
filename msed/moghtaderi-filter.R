##
## Moghtaderi energy-ratio approach helpers
## ---------------------------------------
## These functions derive grouped components from CEEMD results using
## energetic criteria (gi) and ratio criteria (ri) to select a split index i_.
library(EMD)
...
energy_ratio_approach = function(param_sup, param_inf, returns){
  ...
  ## Ratio criteria (RI) thresholds in log2 scale
