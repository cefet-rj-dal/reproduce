##
## Evaluation helpers for component/event categories
## -------------------------------------------------
## - add_row_component/add_row_anomaly: accumulate counts per domain group
## - outliers: basic boxplot-based anomaly detection returning event df
## - soft_evaluate_components: SoftED-style soft window matching
