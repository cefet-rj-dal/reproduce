##
## 5 - Synthetic Examples (Anomaly): Multi-Scale Event Detection
## -------------------------------------------------------------
## Purpose:
## - Load synthetic anomaly series and reference labels (harbinger examples)
## - Evaluate MSED under different soft window sizes and report metrics
##
