...
## --------------------------
## Contains duplicated helpers for component grouping similar to
## moghtaderi-filter.R. Kept for backward compatibility; prefer the
## versions in moghtaderi-filter.R when possible.
##
